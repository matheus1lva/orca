...
export class DaemonPtyAdapter implements IPtyProvider {
  ...
  private async doSpawn(
    ...
    // Why: requireReattach/attachOnly must not cold-restore; probe status covers valid/quarantined history.
    const historyProbe =
      !opts.requireReattach && !opts.attachOnly && this.historyReader
